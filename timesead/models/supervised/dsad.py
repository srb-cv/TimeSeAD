...
class DeepSADTS(BaseModel):
    ...
    def _initialize_architecture(self, n_features, n_output=20, seq_len=100, d_model=128,
        ...
        self.d_model = d_model
        n_hidden, n_layers = self._handle_n_hidden(n_hidden)
    ...
    def forward(self, X: Tuple[torch.Tensor, ...], padding_masks=None) -> torch.Tensor:
        """
        Args:
